...
- **Discover** — public projects in this workspace that you have not joined yet.
- **Archived** — archived projects, kept for reference.
- **Announcements** — release notes and broadcast notices. A dot appears when unread items exist.
- **Projects** — your projects. Drag to reorder, click to expand and see per-project pages (Issues, Categories, Trash, Workspace settings).
- **Realtime connected** — a live indicator at the bottom showing the status of your WebSocket link to the server. When it is green, changes other members make appear in your view instantly.

## The top bar and user menu
...
- Head over to **[Issues](Issues)** to see how work is tracked.
- Read **[Projects](Projects)** to create your own project.
- Visit **[Profile](Profile)** to choose your language and theme.
